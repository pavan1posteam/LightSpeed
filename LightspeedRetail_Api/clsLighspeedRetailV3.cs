...
{
   public class clsLighspeedRetailV3
   {
        ...
        public clsLighspeedRetailV3(int _StoreId, decimal _tax, string _BaseUrl, string _ClientId, string _ClientSecret, string _RefreshToken, int _AccountID, bool _IsMarkUpPrice, int _MarkUpValue)
        {
            StoreId = _StoreId;
            tax = _tax;
            BaseUrl = _BaseUrl;
        ...
        public async Task RunAsync()
        {
            try
            {
                await LighspeedRetailV3(StoreId, tax, BaseUrl, ClientId, ClientSecret, RefreshToken, AccountID, IsMarkUpPrice, MarkUpValue);
        ...
        public async Task LighspeedRetailV3(int storeid, decimal tax, string BaseUrl, string ClientId, string ClientSecret, string RefreshToken, int AccountID, bool IsMarkUpPrice, int MarkUpValue)
        {
        ...
        #region OLD getProduct, LightspeedSetting
        //public string getProduct(string BaseUrl, int storeid, string clientid, string clientsecret,string RefreshToken)
        //    {
        //        string AccessToken = "";
